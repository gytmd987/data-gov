...
urlpatterns = [
    ...
    path("docs/<str:doc_id>/info", views.docs_info, name="console_docs_info"),
    ...
    path("docs/queue", views.queue_action, name="console_queue_action"),
    path("cleanup/", views.cleanup, name="console_cleanup"),
    path("cleanup/apply", views.cleanup_apply, name="console_cleanup_apply"),
    path("folders/", views.folders, name="console_folders"),
